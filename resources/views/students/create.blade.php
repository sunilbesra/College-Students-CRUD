                    ...
                    <form action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="college" class="form-control" id="college" value="{{ old('college') }}">
                                @error('college')
                                    <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    <div class="form-check d-flex align-items-center">
                                        <input class="form-check-input" type="radio" name="enrollment_status" id="enrollment_full" value="full_time" {{ old('enrollment_status')=='full_time' ? 'checked' : '' }}>
                                        <label class="form-check-label mb-0 ms-2" for="enrollment_full">Full-time</label>
                                    </div>
                                    <div class="form-check d-flex align-items-center">
                                        <input class="form-check-input" type="radio" name="enrollment_status" id="enrollment_part" value="part_time" {{ old('enrollment_status')=='part_time' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-8 mt-2">
                                ...
                                <select name="course" id="course" class="form-select">
                                    ...
                                    <option value="bsc" {{ old('course')=='bsc' ? 'selected' : '' }}>B.Sc</option>
                                    <option value="ba" {{ old('course')=='ba' ? 'selected' : '' }}>B.A</option>
                                    <option value="bcom" {{ old('course')=='bcom' ? 'selected' : '' }}>B.Com</option>
                                    <option value="mca" {{ old('course')=='mca' ? 'selected' : '' }}>MCA</option>
                                    <option value="msc" {{ old('course')=='msc' ? 'selected' : '' }}>M.Sc</option>
                                </select>
                                @error('course') <div class="text-danger small">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-4 mt-4">
                                <div class="form-check d-flex align-items-center">
                                    <input class="form-check-input" type="checkbox" name="agreed_to_terms" id="agreed_to_terms" value="1" {{ old('agreed_to_terms') ? 'checked' : '' }}>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mt-2">
                                    <img id="profileImagePreview" src="#" alt="Preview" style="display:none;max-width:120px;max-height:120px;border-radius:50%;object-fit:cover;border:2px solid #eee;" />
                                </div>
                                @error('profile_image')
                                    <div class="text-danger small">{{ $message }}</div>
                                @enderror
